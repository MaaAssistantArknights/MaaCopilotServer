...
namespace MaaCopilotServer.Infrastructure.Migrations
{
    ...
    [Migration("20220831052915_AddCustomFieldInArkLevel")]
    partial class AddCustomFieldInArkLevel
    {
            ...
            modelBuilder.Entity("MaaCopilotServer.Domain.Entities.ArkLevelData", b =>
                {
                    ...
                    b.Property<Guid?>("KeywordEntityId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MaaCopilotServer.Domain.Entities.ArkLevelData", b =>
                {
                    ...
                    b.HasOne("MaaCopilotServer.Domain.Entities.ArkI18N", "Keyword")
                        .WithMany()
                        .HasForeignKey("KeywordEntityId");
