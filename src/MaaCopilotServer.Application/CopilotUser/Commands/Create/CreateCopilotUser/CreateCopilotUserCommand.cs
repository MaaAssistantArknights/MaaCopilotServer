...
public record CreateCopilotUserCommand : IRequest<MaaApiResponse<GetCopilotUserDto>>
{
    /// <summary>
    ///     The user email.
    /// </summary>
...
/// </summary>
public class CreateCopilotUserCommandHandler : IRequestHandler<CreateCopilotUserCommand, MaaApiResponse<GetCopilotUserDto>>
{
    /// <summary>
    ...
    public async Task<MaaApiResponse<GetCopilotUserDto>> Handle(CreateCopilotUserCommand request,
