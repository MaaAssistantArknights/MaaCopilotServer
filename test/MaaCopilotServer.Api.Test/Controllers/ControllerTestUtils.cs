...
namespace MaaCopilotServer.Api.Test.Properties
{
    ...
    internal sealed class ControllerTestUtils
    {
        ...
        /// <returns>N/A</returns>
        internal static async Task TestControllerEndpoint<TRequest, TResponse>(IMediator mediator, TRequest testRequest, TResponse testResponse, Func<TRequest, Task<ActionResult>> controllerAction)
        {
        ...
        /// <param name="testResponse">The test response.</param>
        /// <returns>N/A</returns>
        internal static async Task TestControllerEndpointWithException<TRequest>(IMediator mediator, TRequest testRequest, Func<TRequest, Task<ActionResult>> controllerAction)
        {
